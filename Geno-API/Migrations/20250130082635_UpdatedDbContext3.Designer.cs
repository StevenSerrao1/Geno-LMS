...
namespace Geno_API.Migrations
{
    ...
    [Migration("20250130082635_UpdatedDbContext3")]
            ...
            modelBuilder.Entity("Geno_API.Entities.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CourseId = 1,
                            CreatedByAdminId = 1,
                            CreatedDate = new DateTime(2025, 1, 30, 8, 26, 34, 269, DateTimeKind.Utc).AddTicks(8704),
                        ...
                        new
                        {
                            CourseId = 2,
                            CreatedByAdminId = 1,
                            CreatedDate = new DateTime(2025, 1, 30, 8, 26, 34, 269, DateTimeKind.Utc).AddTicks(8708),
            ...
            modelBuilder.Entity("Geno_API.Entities.Enrolment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EnrolmentId = 1,
                            CourseId = 1,
                            EnrolmentDate = new DateTime(2025, 1, 30, 8, 26, 34, 269, DateTimeKind.Utc).AddTicks(8754),
                            StudentId = 2
                        },
                        new
                        {
                            EnrolmentId = 2,
                            CourseId = 2,
                            EnrolmentDate = new DateTime(2025, 1, 30, 8, 26, 34, 269, DateTimeKind.Utc).AddTicks(8757),
                            StudentId = 2
                        },
                        new
                        {
                            EnrolmentId = 3,
                            CourseId = 2,
                            EnrolmentDate = new DateTime(2025, 1, 30, 8, 26, 34, 269, DateTimeKind.Utc).AddTicks(8759),
                            StudentId = 3
                        },
                        new
                        {
                            EnrolmentId = 4,
                            CourseId = 1,
                            EnrolmentDate = new DateTime(2025, 1, 30, 8, 26, 34, 269, DateTimeKind.Utc).AddTicks(8761),
                            StudentId = 3
                        });
                });
            ...
            modelBuilder.Entity("Geno_API.Entities.Users.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "Serrao",
                            Role = "Admin",
                            DateJoined = new DateTime(2025, 1, 30, 8, 26, 34, 269, DateTimeKind.Utc).AddTicks(8191)
                        });
                });
            ...
            modelBuilder.Entity("Geno_API.Entities.Users.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Role = "Student",
                            AdminId = 1,
                            DateJoined = new DateTime(2025, 1, 30, 8, 26, 34, 269, DateTimeKind.Utc).AddTicks(8646)
                        },
                        new
                        {
                            UserId = 3,
                            ...
                            Role = "Student",
                            AdminId = 1,
                            DateJoined = new DateTime(2025, 1, 30, 8, 26, 34, 269, DateTimeKind.Utc).AddTicks(8651)
                        });
                });
