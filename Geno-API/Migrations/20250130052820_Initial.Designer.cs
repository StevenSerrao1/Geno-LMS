...
namespace Geno_API.Migrations
{
    ...
    [Migration("20250130052820_Initial")]
            ...
            modelBuilder.Entity("Geno_API.Entities.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CourseId = 1,
                            CreatedByAdminId = 1,
                            CreatedDate = new DateTime(2025, 1, 30, 5, 28, 19, 751, DateTimeKind.Utc).AddTicks(6799),
                        ...
                        new
                        {
                            CourseId = 2,
                            CreatedByAdminId = 1,
                            CreatedDate = new DateTime(2025, 1, 30, 5, 28, 19, 751, DateTimeKind.Utc).AddTicks(6803),
            ...
            modelBuilder.Entity("Geno_API.Entities.Enrolment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EnrolmentId = 1,
                            CourseId = 1,
                            EnrolmentDate = new DateTime(2025, 1, 30, 5, 28, 19, 751, DateTimeKind.Utc).AddTicks(6855),
                            StudentId = 2
                        },
                        new
                        {
                            EnrolmentId = 2,
                            CourseId = 2,
                            EnrolmentDate = new DateTime(2025, 1, 30, 5, 28, 19, 751, DateTimeKind.Utc).AddTicks(6857),
                            StudentId = 2
                        },
                        new
                        {
                            EnrolmentId = 3,
                            CourseId = 2,
                            EnrolmentDate = new DateTime(2025, 1, 30, 5, 28, 19, 751, DateTimeKind.Utc).AddTicks(6859),
                            StudentId = 3
                        });
                });
            ...
            modelBuilder.Entity("Geno_API.Entities.Users.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "Serrao",
                            Role = "Admin",
                            DateJoined = new DateTime(2025, 1, 30, 5, 28, 19, 751, DateTimeKind.Utc).AddTicks(6128)
                        });
                });
            ...
            modelBuilder.Entity("Geno_API.Entities.Users.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Role = "Student",
                            AdminId = 1,
                            DateJoined = new DateTime(2025, 1, 30, 5, 28, 19, 751, DateTimeKind.Utc).AddTicks(6611)
                        },
                        new
                        {
                            UserId = 3,
                            ...
                            Role = "Student",
                            AdminId = 1,
                            DateJoined = new DateTime(2025, 1, 30, 5, 28, 19, 751, DateTimeKind.Utc).AddTicks(6616)
                        });
                });
