...
namespace Geno_API.Migrations
{
    ...
    [Migration("20250130054905_UpdatedDbContext1")]
    partial class UpdatedDbContext1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Geno_API.Entities.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CourseId = 1,
                            CreatedByAdminId = 1,
                            CreatedDate = new DateTime(2025, 1, 30, 5, 49, 4, 242, DateTimeKind.Utc).AddTicks(6611),
                        ...
                        new
                        {
                            CourseId = 2,
                            CreatedByAdminId = 1,
                            CreatedDate = new DateTime(2025, 1, 30, 5, 49, 4, 242, DateTimeKind.Utc).AddTicks(6614),
            ...
            modelBuilder.Entity("Geno_API.Entities.Enrolment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EnrolmentId = 1,
                            CourseId = 1,
                            EnrolmentDate = new DateTime(2025, 1, 30, 5, 49, 4, 242, DateTimeKind.Utc).AddTicks(6648),
                            StudentId = 2
                        },
                        new
                        {
                            EnrolmentId = 2,
                            CourseId = 2,
                            EnrolmentDate = new DateTime(2025, 1, 30, 5, 49, 4, 242, DateTimeKind.Utc).AddTicks(6650),
                            StudentId = 2
                        },
                        new
                        {
                            EnrolmentId = 3,
                            CourseId = 2,
                            EnrolmentDate = new DateTime(2025, 1, 30, 5, 49, 4, 242, DateTimeKind.Utc).AddTicks(6651),
                            StudentId = 3
                        });
                });
            ...
            modelBuilder.Entity("Geno_API.Entities.Users.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "Serrao",
                            Role = "Admin",
                            DateJoined = new DateTime(2025, 1, 30, 5, 49, 4, 242, DateTimeKind.Utc).AddTicks(6222)
                        });
                });
            ...
            modelBuilder.Entity("Geno_API.Entities.Users.Student", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Role = "Student",
                            AdminId = 1,
                            DateJoined = new DateTime(2025, 1, 30, 5, 49, 4, 242, DateTimeKind.Utc).AddTicks(6474)
                        },
                        new
                        {
                            UserId = 3,
                            ...
                            Role = "Student",
                            AdminId = 1,
                            DateJoined = new DateTime(2025, 1, 30, 5, 49, 4, 242, DateTimeKind.Utc).AddTicks(6478)
                        });
                });
